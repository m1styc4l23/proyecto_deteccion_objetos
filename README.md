...
Este repo basado en el proyecto [PyTorch YOLOv3](https://github.com/eriklindernoren/PyTorch-YOLOv3) para correr detección de objetos sobre video. Construímos sobre este proyecto para añadir la capacidad de detectar y contar objetos en un stream de video en vivo.
...
# Correr el detector de objetos en tiempo real 
...
# Correr el detector de objetos en un video 
